...
{
    public class Enemy : ObjectWithAnimation, IBattle
    {
        //Форма инвентаря.
        public Inventar Inventar { get; set; }

        //делегат изменения хп в главной форме
        public GetHp ChangeHpVisual { get; set; }
        ...
        public Enemy(System.Drawing.Bitmap[] Pictures, int Width, int High, int Hp, int Damage, int RangeAttack, double Armor, GetHp ChangeHpVisual, System.Drawing.Pen Weapon, MainWindow mainWindow, int X = 0, int Y = 0)
           : base(Pictures, Width, High, X, Y)
        {
            ...
            Inventar = new Inventar("Враг", mainWindow, this);
        ...
        public void AddTypeADR(string Type, double[] ParametrsArmorDamageRange)
        {
            if (ParametrsArmorDamageRange.Length != 3)
                throw new ArgumentOutOfRangeException("Должно быть 3 аргумента массива Double");
